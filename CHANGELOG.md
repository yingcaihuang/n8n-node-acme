...
### 重大变更 - 全新设计
- 完全重新设计凭证和Provider系统
- 支持阿里云DNS和Dnspod DNS两个提供商
- 实现动态凭证选择，根据选择的DNS提供商显示对应配置
...
### 重大变更
- 简化节点配置，只支持Dnspod DNS提供商
- 删除其他DNS提供商支持（阿里云、Cloudflare、AWS Route 53、百度云、华为云）
- 简化用户界面，只显示Dnspod相关配置

### 删除的功能
- 移除阿里云DNS提供商支持
- 移除Cloudflare DNS提供商支持
- 移除AWS Route 53 DNS提供商支持
- 移除百度云DNS提供商支持
- 移除华为云DNS提供商支持
